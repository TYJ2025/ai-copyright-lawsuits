...
> - Judge=Chhabria
> - Status=active
> - Progress=【重大裁定】2025 年 6 月 25 日，Chhabria 法官准許 Meta 的簡易判決動議，認定以書籍訓練 LLaMA 構成合理使用。法院認為該使用具有「高度轉化性」，因其目的是訓練工具生成多樣化輸出，而非取代原著作品。 【重要但書】法官明確指出：本判決「不代表 Meta 使用著作權資料訓練語言模型是合法的。它只代表這些原告提出了錯誤的論據，且未能建立支持正確論據的紀錄。」 本案已合併 Chabon v. Meta 及 Farnsworth v. Meta。DMCA §1202(b)(1) 的簡易判決也被駁回。 【2026/3/27】法院發布新訴訟時程表，分配請求（distribution claim）簡易判決聽證會延至 2027 年 2 月 25 日舉行。 【2026/4/2】Summary Judgment 程序正式完成。Chhabria 法官將於近期宣布分配請求（distribution claim）相關裁定。合理使用判決確定後的殘餘爭點（包括 DMCA 及州法主張）繼續審理中。 【2026/4/18】根據 TorrentFreak 3 月底報導，Chhabria 法官於近

**自動比對結果：**

- ✅ Court 一致：dashboard 寫「N.D. Cal.」，CourtListener 為「N.D. California」
- ✅ Judge 一致：dashboard 寫「Chhabria」，CourtListener 為「Vince Chhabria」
- ℹ️ Dashboard progress 略落後 3 天：dashboard 最新日期 2026-04-18，CourtListener 最後 entry 2026-04-21
